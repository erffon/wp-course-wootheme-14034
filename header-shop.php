                ...
                <div class="ht-right">
                    <div class="ht-right_info">
                        <ul class="ht-info-list">
                            ...
                            <li>
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#register">ثبت نام </a> یا
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#login">ورود </a>
                            </li>
                    ...
                    <div class="nav-items main-menu-wraper">
                        <ul class="menu-list d-xl-flex">
                            ...
                            if ($product_main_cats) :
                                foreach ($product_main_cats as $cat) :
                            ?>
                                    <li>
                                                            ...
                                                            <ul class="super-sub-menu">
                                                                ...
                                                                if ($xsub_categories) :
                                                                    foreach ($xsub_categories as $xsub) : ?>
                                                                        <li><a href="<?php echo get_category_link($xsub->cat_ID); ?>"><?php echo  $xsub->name ?></a></li>
                                                                    <?php endforeach; ?>
                                                                <?php endif; ?>
                                                            </ul>
                                                        </li>
                                ...
                                <?php endforeach; ?>
                            <?php else : ?>
                                <div class="alert alert-warning">دسته بندی موجود نیست</div>
                            <?php endif; ?>
                            ...
                            <li class="hs-cart-box cmn-cart-tgl">
                                <a href="javascript:void(0);">
                                    <div class="hs-cartbox-inner">
                                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" width="22px" height="20px">
