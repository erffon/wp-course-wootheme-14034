                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-5 col-lg-6 order-lg-last col-md-12 order-first col-sm-12 col-12">
                                    <div class="e-banner-img">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/images/index1/baner01.png' ?>" alt="image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="e-inner-slide slide1">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-xl-5 col-lg-6 order-lg-last col-md-12 order-first col-sm-12 col-12">
                                    <div class="e-banner-img">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/images/index1/baner02.png' ?>" alt="image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="e-inner-slide slide1">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-xl-5 col-lg-6 order-lg-last col-md-12 order-first col-sm-12 col-12">
                                    <div class="e-banner-img">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/images/index1/baner01.png' ?>" alt="image-3" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
